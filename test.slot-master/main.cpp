...
int main(int argc, char* args[])
{
	...
	BackBuffer = SDL_SetVideoMode(800,600,32,SDL_DOUBLEBUF|SDL_HWSURFACE); //SDL_DOUBLEBUF
...
bool LoadFiles()
{
	Background = LoadImage("/home/serg/test_sdl/test.slot/res/backfon.png", false);

	if(Background == NULL)
		return false;

	SpriteImage = LoadImageAlpha("/home/serg/test_sdl/test.slot/res/reel.png");
